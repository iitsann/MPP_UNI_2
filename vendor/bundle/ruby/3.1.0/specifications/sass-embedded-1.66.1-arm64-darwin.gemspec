# -*- encoding: utf-8 -*-
# stub: sass-embedded 1.66.1 arm64-darwin lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "documentation_uri" => "https://rubydoc.info/gems/sass-embedded/1.66.1", "funding_uri" => "https://github.com/sponsors/ntkme", "source_code_uri" => "https://github.com/ntkme/sass-embedded-host-ruby/tree/v1.66.1" } if s.respond_to? :metadata=
